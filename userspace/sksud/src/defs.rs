...
mod android {
    ...
    pub const DAEMON_PATH: &str = concatcp!(ADB_DIR, "sksud");
    pub const LIBADBROOT_PATH: &str = concatcp!(LIBRARY_DIR, "libadbroot.so");

    pub const DAEMON_LINK_PATH: &str = concatcp!(BINARY_DIR, "sksud");
    ...
    pub const PREINIT_DIR_WATCHDOG: &str = "/metadata/watchdog/sks/";
    pub const PREINIT_DIR_DEFAULT: &str = "/metadata/sks/";
    ...
    pub const SKS_BACKUP_DIR: &str = WORKING_DIR;
    pub const SKS_BACKUP_FILE_PREFIX: &str = "sksu_backup_";
