...
::: info INFORMAÇÕES
[SxKernelSU 1.0 e versões posteriores não suportam mais kernels não-GKI](https://github.com/linchuanlu56-dot/SxKernelSU/issues/1705). A última versão suportada é a `v0.9.5`, portanto, certifique-se de usar a versão correta.
:::
