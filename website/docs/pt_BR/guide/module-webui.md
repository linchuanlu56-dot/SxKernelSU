...
Além de executar scripts de inicialização e modificar arquivos do sistema, os módulos do SxKernelSU também suportam a exibição de interfaces da UI e à interação direta com os usuários.

O módulo pode escrever páginas HTML + CSS + JavaScript através de qualquer tecnologia web. O gerenciador do SxKernelSU exibirá essas páginas através do WebView. Ele também fornece algumas APIs para interagir com o sistema, como executar comandos shell.
...
::: warning AVISO
Ao instalar o módulo, SxKernelSU definirá automaticamente as permissões e o contexto do SELinux deste diretório. Se você não sabe o que está fazendo, não defina você mesmo as permissões deste diretório!
:::
...
Se você achar que a API existente não atende às suas necessidades ou é inconveniente de usar, fique à vontade para nos dar sugestões [aqui](https://github.com/linchuanlu56-dot/SxKernelSU/issues)!
