...
Desde o SxKernelSU v3.0, abandonamos o suporte oficial para o modo de imagem GKI para iteração e velocidade de compilação mais rápidas. É recomendado usar `Ylarod/ddk` para compilar o LKM.
:::
...
## Compilar o kernel com SxKernelSU

Se você conseguir compilar o kernel com sucesso, adicionar suporte ao SxKernelSU será relativamente simples. Na raiz do diretório de origem do kernel, execute qualquer uma das opções listadas abaixo:
...
Então, reconstrua o kernel e você obterá uma imagem do kernel com o SxKernelSU!
