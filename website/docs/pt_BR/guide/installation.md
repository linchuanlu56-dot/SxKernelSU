...
Baixe o gerenciador do SxKernelSU em [GitHub Releases](https://github.com/tiann/SxKernelSU/releases) e instale-o no seu dispositivo:
...
Desde a versão [0.9.0](https://github.com/tiann/SxKernelSU/releases/tag/v0.9.0), o SxKernelSU suporta dois modos de execução em dispositivos GKI:
...
Você pode baixar o boot.img em [GitHub Release](https://github.com/tiann/SxKernelSU/releases). Por favor, observe que você deve usar a versão correta do boot.img. Se você não sabe qual arquivo baixar, leia atentamente a descrição do [KMI](#kmi) e [Nível do patch de segurança](#security-patch-level) neste documento.
