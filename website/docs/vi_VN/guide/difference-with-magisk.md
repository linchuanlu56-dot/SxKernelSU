...
- Các thư mục của BusyBox khác nhau. BusyBox tích hợp trong SxKernelSU nằm ở `/data/adb/sks/bin/busybox`, trong khi ở Magisk nó nằm ở `/data/adb/magisk/busybox`. **Lưu ý rằng đây là hoạt động nội bộ của SxKernelSU và có thể thay đổi trong tương lai!**
