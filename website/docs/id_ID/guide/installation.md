...
Unduh manajer SxKernelSU dari [GitHub Releases](https://github.com/tiann/SxKernelSU/releases) dan instal ke perangkat Anda:
...
Sejak versi [0.9.0](https://github.com/tiann/SxKernelSU/releases/tag/v0.9.0), SxKernelSU mendukung dua mode berjalan pada perangkat GKI:
...
Anda dapat mengunduh boot.img dari [GitHub Release](https://github.com/tiann/SxKernelSU/releases). Harap dicatat bahwa Anda harus menggunakan versi boot.img yang benar. Jika Anda tidak tahu file mana yang harus diunduh, baca dengan cermat deskripsi [KMI](#kmi) dan [Tingkat patch keamanan](#security-patch-level) dalam dokumen ini.
