...
features:
  - title: Kernel-based
    details: SxKernelSU bekerja dalam mode Linux kernel, dan mempunyai kelebihan diatas aplikasi userspace.
  ...
  - title: Sumber terbuka
    details: SxKernelSU adalah projek sumber terbuka dibawah lisensi GPL-3.
