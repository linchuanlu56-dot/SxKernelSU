...
[GitHub Releases](https://github.com/tiann/SxKernelSU/releases) から SxKernelSU Manager アプリをダウンロードし、お使いのデバイスにインストールしてください。
...
バージョン [0.9.0](https://github.com/tiann/SxKernelSU/releases/tag/v0.9.0) 以降、SxKernelSU は GKI 端末において 2 つの動作モードに対応しています。
...
このツールは macOS、Linux および Windows に対応しています。[GitHub Release](https://github.com/tiann/SxKernelSU/releases) から対応するバージョンをダウンロードしてください。
...
boot.img は、[GitHub Release](https://github.com/tiann/SxKernelSU/releases) からダウンロードできます。例えば、あなたのデバイスがカーネル `android12-5.10.101` の場合、`android-5.10.101_yyyy-MM.boot-<format>.img`をダウンロードする必要があります。（KMI を同じにしてください！）。
...
1. SxKernelSUの[リリースページ](https://github.com/tiann/SxKernelSU/releases)から、お使いのデバイスのバージョンにあった AnyKernel3 で始まる ZIP パッケージをダウンロードします。例えば、デバイスのカーネルのバージョンが`android12-5.10. 66`の場合、AnyKernel3-android12-5.10.66_yyyy-MM.zip`（yyyy`は年、`MM`は月）のファイルをダウンロードします。
