...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
        ...
        copyright: 'Copyright © 2022-present SxKernelSU developers.'
    },
...
function nav() {
  return [
    { text: 'Guide', link: '/guide/what-is-sxkernelsu' },
  ]
}
  ...
  return [
    {
        text: 'Guide',
        items: [
          { text: 'What is SxKernelSU?', link: '/guide/what-is-sxkernelsu' },
          { text: 'Difference with KernelSU', link: '/guide/difference-with-kernelsu' },
