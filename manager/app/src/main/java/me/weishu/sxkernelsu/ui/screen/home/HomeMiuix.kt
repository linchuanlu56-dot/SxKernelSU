                            ...
                            if (state.currentManagerVersionCode < (state.ksuVersion ?: 0)) {
                                ...
                                WarningCard(
                                    stringResource(
                                        ...
                                        state.ksuVersion ?: 0,
                                        com.sxkernelsu.Natives.MINIMAL_SUPPORTED_KERNEL
                                    )
                                )
                            }
                        }
...
private fun LearnMoreCard(
    ...
    Card(modifier = Modifier.fillMaxWidth()) {
        BasicComponent(
            title = stringResource(R.string.home_learn_sxkernelsu),
            summary = stringResource(R.string.home_click_to_learn_sxkernelsu),
            endActions = {
                Icon(
