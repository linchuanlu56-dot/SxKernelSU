...
import com.sxkernelsu.data.model.Author
import com.sxkernelsu.data.model.ReleaseAsset
...
class ModuleRepoRepositoryImpl : ModuleRepoRepository {
    ...
    companion object {
        private const val MODULES_URL = "https://modules.sxkernelsu.org/modules.json"
    }
