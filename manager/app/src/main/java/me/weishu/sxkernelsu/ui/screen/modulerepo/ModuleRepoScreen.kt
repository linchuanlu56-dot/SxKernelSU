...
import com.sxkernelsu.ui.viewmodel.ModuleRepoViewModel
import com.sxkernelsu.ui.viewmodel.ModuleViewModel
...
fun ModuleRepoDetailScreen(module: RepoModuleArg) {
    ...
    var webUrl by remember(module.moduleId) { mutableStateOf("https://modules.sxkernelsu.org/module/${module.moduleId}") }
    var sourceUrl by remember(module.moduleId) { mutableStateOf("https://github.com/SxKernelSU-Modules-Repo/${module.moduleId}") }
