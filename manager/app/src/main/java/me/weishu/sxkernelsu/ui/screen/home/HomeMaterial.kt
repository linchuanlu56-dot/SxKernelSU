package com.sxkernelsu.ui.screen.home
...
import androidx.compose.ui.unit.dp
import com.sxkernelsu.KernelVersion
...
private fun LearnMoreCard(onOpenUrl: (String) -> Unit) {
    val url = stringResource(R.string.home_learn_sxkernelsu_url)
    TonalCard(onClick = { onOpenUrl(url) }) {
        Row(
            ...
            Column {
                Text(text = stringResource(R.string.home_learn_sxkernelsu), style = MaterialTheme.typography.titleSmall)
                Spacer(Modifier.height(4.dp))
                Text(
                    text = stringResource(R.string.home_click_to_learn_sxkernelsu),
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.outline
                )
            }
...
private fun previewHomeScreenState(
    ...
    latestVersionInfo = com.sxkernelsu.ui.util.module.LatestVersionInfo(),
