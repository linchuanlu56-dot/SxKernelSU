...
import com.sxkernelsu.Natives.Profile.RootProfileFlag
...
object Natives {
    ...
    const val SXKERNEL_SU_DOMAIN = "u:r:ksu:s0"

    const val ROOT_UID = 0
    const val ROOT_GID = 0

    init {
        System.loadLibrary("sxkernelsu")
    }
    ...
    data class Profile(
        ...
        val context: String = SXKERNEL_SU_DOMAIN,
        val namespace: Int = Namespace.INHERITED.ordinal,

        val nonRootUseDefault: Boolean = true,
        val umountModules: Boolean = true,
        var rules: String = "", // this field is save in sksud!!

        val flags: Long = FLAG_SKS_NO_NEW_PRIVS,
    ) : Parcelable {
        @Keep
    ...
    const val FLAG_SKS_NO_NEW_PRIVS = 1L
}
