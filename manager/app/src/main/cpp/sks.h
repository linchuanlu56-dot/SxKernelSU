...
#ifndef SXKERNELSU_SKS_H
#define SXKERNELSU_SKS_H
...
using p_key_t = char[SKS_MAX_PACKAGE_NAME];
...
bool get_allow_list(struct sksu_new_get_allow_list_cmd *);
