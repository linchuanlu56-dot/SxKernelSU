#ifndef __SKS_H_TP_MARKER
#define __SKS_H_TP_MARKER
...
static inline void sksu_set_task_tracepoint_flag(struct task_struct *t)
{
...
static inline void sksu_clear_task_tracepoint_flag(struct task_struct *t)
{
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 11, 0)
