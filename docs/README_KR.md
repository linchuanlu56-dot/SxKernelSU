...
2. [metamodules](https://linchuanlu56-dot.github.io/SxKernelSU/guide/metamodule.html) 기반 모듈 시스템: 플러그인 가능한 시스템리스 수정 인프라.
3. [App Profile](https://linchuanlu56-dot.github.io/SxKernelSU/guide/app-profile.html): 루트 권한을 케이지에 가둡니다.

## 호환 상태

SxKernelSU는 공식적으로 안드로이드 GKI 2.0 디바이스(커널 5.10 이상)를 지원합니다. 오래된 커널(4.14 이상)도 사용할 수 있지만, 커널을 수동으로 빌드해야 합니다.

SxKernelSU는 WSA, ChromeOS, 컨테이너 기반 안드로이드 모두를 지원합니다.

현재 `arm64-v8a` 및 `x86_64` 아키텍처가 지원됩니다.

> [!CAUTION]
> 최신 커널 버전에는 SxKernelSU가 실패하고 `x86_64`에서 커널 패닉을 일으킬 수 있는 치명적인 변경 사항이 적용되었습니다! 자세한 내용은 웹사이트를 확인하세요!

## 사용 방법

- [설치 방법](https://linchuanlu56-dot.github.io/SxKernelSU/guide/installation.html)
- [어떻게 빌드하나요?](https://linchuanlu56-dot.github.io/SxKernelSU/guide/how-to-build.html)
- [공식 웹사이트](https://linchuanlu56-dot.github.io/SxKernelSU/)

## 번역

SxKernelSU 번역을 돕거나 기존 번역을 개선하려면 [Weblate](https://hosted.weblate.org/engage/kernelsu/)를 이용해 주세요. 매니저의 번역은 Weblate와 충돌할 수 있으므로 더 이상 허용되지 않습니다.

## 토론

- 텔레그램: [@SxKernelSU](https://t.me/SxKernelSU)

## 보안

SxKernelSU의 보안 취약점 보고에 대한 자세한 내용은 [SECURITY.md](/SECURITY.md)를 참조하세요.
...
- [kernel-assisted-superuser](https://git.zx2c4.com/kernel-assisted-superuser/about/): SxKernelSU의 아이디어.
