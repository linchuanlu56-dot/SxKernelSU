...
2. מערכת מודולים מבוססת [metamodules](https://linchuanlu56-dot.github.io/SxKernelSU/guide/metamodule.html): תשתית מודולרית לשינויים systemless.
3. [פרופיל אפליקציה](https://linchuanlu56-dot.github.io/SxKernelSU/guide/app-profile.html): נעילת גישת root בכלוב.

## מצב תאימות

SxKernelSU תומך במכשירי Android GKI 2.0 (kernel 5.10+) באופן רשמי. לליבות ישנות (4.14+) יש גם תאימות, אך יידרש לבנות את הליבה באופן ידני.
...
> [!CAUTION]
> גרסאות קרנל אחרונות יישמו שינוי שובר תאימות הגורם ל-SxKernelSU להיכשל ועלול לעורר kernel panic ב-`x86_64`! בדוק באתר למידע נוסף!

## שימוש

- [הוראות התקנה](https://linchuanlu56-dot.github.io/SxKernelSU/guide/installation.html)
- [איך לבנות?](https://linchuanlu56-dot.github.io/SxKernelSU/guide/how-to-build.html)
- [האתר רשמי](https://linchuanlu56-dot.github.io/SxKernelSU/)

## תרגום

כדי לעזור בתרגום של SxKernelSU או לשפר תרגומים קיימים, יש להשתמש ב-[Weblate](https://hosted.weblate.org/engage/kernelsu/).
...
- [kernel-assisted-superuser](https://git.zx2c4.com/kernel-assisted-superuser/about/): הרעיון של SxKernelSU.
